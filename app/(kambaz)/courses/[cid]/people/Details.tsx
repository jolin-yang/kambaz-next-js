    ...
    <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
      ...
      <b>Roles:</b>           
        ...
        <select value={role} onChange={(e) =>setRole(e.target.value)}
              className="form-select d-inline w-75 wd-select-role" >
            <option value="STUDENT">Student</option>
            <option value="TA">Teaching Assistant</option> <option value="FACULTY">Faculty</option>
      ...
      <b>Email:</b>         
        ...
        {editing && <FormControl type="email" className="d-inline w-75" defaultValue={user.email} onChange={(e) => setEmail(e.target.value)} />}
      <br />
