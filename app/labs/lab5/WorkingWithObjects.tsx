...
export default function WorkingWithObjects() {
    ...
    const [module, setModule] = useState({
        id: "1", name: "Introduction to Web Dev",
        description: "An in-depth introduction to web development",
    ...
    return (
        ...
        <a id="wd-update-assignment-completion"
            ...
            Update Completion </a>
        <FormCheck className="fs-5 mt-3 me-3" id="wd-assignment-completion" 
            type="checkbox"
